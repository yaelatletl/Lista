...
do {
	...
	case 2:{		//Aqui se inserta un valor al final de la lista
		printf("Dame un numero a insertar\n");
		scanf("%d", &x);
	...
	case 10: {		//Aqui se recupera el predecesor del elemento ingresado
		printf("Dame un numero a buscar\n");
		scanf("%d", &x);
	...
	case 11:{		//Aqui se muestra todos los datos de la lista
	...
	default:{
		...
		scanf("%d", &opc);
		switch (opc) {
		case 1:{		//Aqui se hace el push de la pila
			printf("Dame el numero a ingresar\n");
			scanf("%d", &x);
			pila.push(x,&bandera);
			getchar();
		...
		case 2:{		//Aqui se hace el pop de la pila
			y = pila.pop(&bandera);
		...
		case 4:{		//Aqui se muestra el estado de la pila, si es que este llena o no
			pila.estado(&bandera);
			break;
		}
